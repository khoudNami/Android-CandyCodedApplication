...
//        shareIntent.setType(Intent.normalizeMimeType("text/plain")).putExtra(Intent.EXTRA_TEXT, stringToShare);
        shareIntent.setType("text/plain");
        shareIntent.putExtra(Intent.EXTRA_TEXT, stringToShare);
//        shareIntent.setTypeAndNormalize("text/plain").putExtra(Intent.EXTRA_TEXT, stringToShare);
